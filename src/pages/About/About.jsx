        ...
        <div className="containerH">
          <div className="descriptionH">
            ...
            <p>
              ...
              through an immersive 1-year full stack software development
              training program at CodeYourFuture. There, I gain hands-on
              experience in
            ...
            <p>
              {" "}
              I graduated from{" "}
              <span className="pulseA">Falmouth University</span> with a{" "}
              <span className="pulseA">BSc in Computing</span> in February 2023,
              where I developed a solid foundation in software development
              ...
              <span className="pulseA">CodeYourFuture</span>, where I built a
              web application with a team of talented developers, delivering
              ...
              concepts into applications that make a positive impact on the
              world.
            </p>
          </div>
          <div className="dataH">
            ...
            <button className="buttonA" onClick={handleDownloadPDF}>
              Download my CV
            </button>
          </div>
        </div>
